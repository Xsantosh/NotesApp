...
class _TodoViewState extends State<TodoView> {
  ...
  Widget build(BuildContext context) {
    final isLoading =
        context.select<TodoViewModel, bool>(((todoViewModel) => todoViewModel.isLoading));
    final todos =
        context.select<TodoViewModel, List<Todo>>(((todoViewModel) => todoViewModel.todos));
        ...
        child: Padding(
          ...
          child: Column(
            children: <Widget>[
              ...
              SearchBar(controller: searchTodoController, hintText: 'Search to-dos'),
              SizedBox(height: 20.h),
              Expanded(
                child: isLoading
                    ? Center(
                            ...
                            itemBuilder: (context, index) => GestureDetector(
                              onLongPress: () {
                                Navigator.of(context)
                                    .pushNamed(Routes.deleteTodoRoute, arguments: [todos, index]);
